...
module my_first_package::color_object {
    ...
    public entry fun create(red: u8, green: u8, blue: u8, ctx: &mut TxContext) {
        let my_first_package = new(red, green, blue, ctx);
        transfer::transfer(my_first_package, tx_context::sender(ctx))
    }
    ...
    public entry fun create_immutable(red: u8, green: u8, blue: u8, ctx: &mut TxContext) {
        let my_first_package = new(red, green, blue, ctx);
        transfer::freeze_object(my_first_package)
    }
